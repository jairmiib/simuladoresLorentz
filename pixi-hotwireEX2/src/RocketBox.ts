...
export class RocketBox extends Container {
  ...
  constructor(globalProps: GlobalProps, app: Application, source:string, width?: number, height?: number, id?: string | undefined){
    super();
    if(id) this.id = id;
    ...
    this.rocket = new Rocket(source, this.colorId, width, height);
